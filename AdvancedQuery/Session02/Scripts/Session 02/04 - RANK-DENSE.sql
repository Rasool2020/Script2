...
/*
تمرین کلاسی
را بدون DENSE_RANK و RANK عملیات مربوط به توابع
.و با توجه به نتایج زیر، شبیه‌سازی کنید WF استفاده از
...
رتبه‌بندی DENSE_RANK کوئری‌ای بنویسید که با استفاده از تابع
