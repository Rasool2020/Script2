...
USE master
GO
BACKUP DATABASE Northwind TO DISK = N'C:\Temp1\Northwind\NorthwindSimple.bak'
	 WITH FORMAT,STATS=1
GO
...
BACKUP DATABASE Northwind TO DISK = N'C:\Temp1\Northwind\Northwind_Normal.bak' 
WITH ENCRYPTION 
( 
	ALGORITHM = AES_256, 
...
BACKUP DATABASE Northwind TO DISK = N'C:\Temp1\Northwind\Northwind_Compression.bak' 
WITH ENCRYPTION 
( 
	ALGORITHM = AES_256, 
	SERVER CERTIFICATE = NorthwindBackupEncryptCert 
),STATS =1,FORMAT,COMPRESSION
GO
/*
...
--1: BACKUP MASTER KEY
BACKUP MASTER KEY TO FILE = 'C:\Temp1\Northwind\MasterKey.key' 
	ENCRYPTION BY PASSWORD = 'p@ssw0rd';
GO
--2: BACKUP CERTIFICATE
BACKUP CERTIFICATE NorthwindBackupEncryptCert 
TO FILE = 'C:\Temp1\Northwind\NorthwindBackupEncryptCert.cert' 
WITH PRIVATE KEY 
	(
		FILE = 'C:\Temp1\Northwind\NorthwindBackupEncryptCert.key', 
		ENCRYPTION BY PASSWORD = 'p@ssw0rd'
	);
--------------------------------------------------------------------
USE master
...
RESTORE DATABASE Northwind FROM DISK = 'C:\Temp1\Northwind\Northwind_Normal.bak'
	WITH REPLACE
--------------------------------------------------------------------
...
/*
RESTORE MASTER KEY 
    FROM FILE = 'C:\Temp1\Northwind\MasterKey.key' 
...
*/
CREATE CERTIFICATE NorthwindBackupEncryptCert
FROM FILE = 'C:\Temp1\Northwind\NorthwindBackupEncryptCert.cert'
	WITH PRIVATE KEY 
	(
		FILE = 'C:\Temp1\Northwind\NorthwindBackupEncryptCert.key',
		DECRYPTION BY PASSWORD = 'p@ssw0rd'
