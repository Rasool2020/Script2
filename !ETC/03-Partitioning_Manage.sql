...
ALTER DATABASE NikAmoozDB2017 ADD FILEGROUP One
ALTER DATABASE NikAmoozDB2017 ADD FILEGROUP Two
ALTER DATABASE NikAmoozDB2017 ADD FILEGROUP Three
ALTER DATABASE NikAmoozDB2017 ADD FILEGROUP Four
GO
--تخصیص دیتا فایل به هر کدام از فایل گروه ها
ALTER DATABASE NikAmoozDB2017 ADD FILE
