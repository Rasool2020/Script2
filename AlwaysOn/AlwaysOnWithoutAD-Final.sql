...
Use master
GO
IF NOT EXISTS (SELECT * FROM sys.certificates WHERE name = 'Cert4AlwaysON_FANAVADB02')
...
Use master
GO
IF NOT EXISTS (SELECT * FROM sys.certificates WHERE name = 'Cert4AlwaysON_AsiaTechDB01')
...
GO
--ایجاد یک لاگین در سرور اصلی 
IF EXISTS(SELECT 1 FROM SYS.sql_logins WHERE name='Alwayson_User')
BEGIN
