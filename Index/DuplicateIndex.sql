...
Where 1=1
	--And OBJECT_SCHEMA_NAME(a.object_id)='Utility'
...
Where Not C1.TableName Like 'sys.%'
--ORDER BY C1.TableName, C1.ConcIndexColumnNrs
ORDER BY C1.IndexUpdates desc
Go
sp_help 'hotel.TbHotelExtraInfoApplicationRole'
Go
sp_helpindex 'hotel.TbHotelHotelFeatures'
Go
Drop Index if exists hotel.TbHotelFacilityHotelFacilityTemplate.IX_HotelExtraInfoRef