...
JOIN sys.schemas Sch ON Sch.[schema_id] = Obj.[schema_id] WHERE index_id > 0)
...
JOIN MyDuplicate MD2 ON MD1.tablename = MD2.tablename
...
Go
SELECT   
    INDEX_COL (N'IPA_booking_ir.Flight.TbFlightItem', 1,1) AS  
        [Index Column 1],   
    INDEX_COL (N'IPA_booking_ir.Flight.TbFlightItem', 1,2) AS  
        [Index Column 1],   
    INDEX_COL (N'IPA_booking_ir.Flight.TbFlightItem', 1,2) AS  
        [Index Column 1],   
Go
Sp_helpindex 'IPA_booking_ir.Flight.TbFlightItem'