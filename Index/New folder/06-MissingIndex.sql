...
SELECT mid.statement ,mig.index_group_handle,mid.index_handle,migs.avg_total_user_cost AS AvgTotalUserCostThatCouldbeReduced,
...
Where 1=1
	And mid.statement  ='[sepideh].[dbo].[t08Project]'
	And (mid.equality_columns like '%alternate_code%' or mid.included_columns like '%alternate_code%')
