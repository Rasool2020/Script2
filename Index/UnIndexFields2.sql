--	ForeignKey Index
Select o.name TableName,c.Name columnName,'if Not Exists(Select 1 From sysindexes Where name=''IX_' + o.name + '_' + c.Name + ''') CREATE NONCLUSTERED INDEX IX_' + o.name + '_' + c.Name + ' ON ' + o.name + '(' + c.Name + ') ON Index1'
From syscolumns c
...
Go
--	Unique Index
Select o.name TableName,c.Name columnName,'if Not Exists(Select 1 From sysindexes Where name=''IX_' + o.name + '_' + c.Name + ''') CREATE UNIQUE NONCLUSTERED INDEX IX_' + o.name + '_' + c.Name + ' ON ' + o.name + '(' + c.Name + ') ON Index1'
From syscolumns c
join sysobjects o on c.id=o.id
